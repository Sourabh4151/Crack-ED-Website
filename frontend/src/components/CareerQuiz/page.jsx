...
const PROGRAM_DETAILS = {
  ...
  'Bandhan Bank Aspiring Bank Champions Programme - Assistant Manager': { details: 'CTC of 4 LPA* + Variables', duration: '6-month program', link: 'https://bandhanbankassistantmanager.crack-ed.com/' },
