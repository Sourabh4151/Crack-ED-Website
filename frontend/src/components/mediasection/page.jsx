      ...
      <div className="media-container">
        ...
        <div className="slider-wrapper">
          ...
          <div className="slider-controls">
            <button type="button" onClick={handlePrev} className="control-btn" aria-label="Previous media">
            ...
            <button type="button" onClick={handleNext} className="control-btn" aria-label="Next media">
