...
const PROGRAM_FEES = {
  ...
  'Banking Sales Program - Business Development Executive': 60000,
...
const PROGRAM_DETAILS = {
  ...
  'Banking Sales Program - Business Development Executive': { details: 'CTC of ₹2.75 to ₹3.25 LPA', duration: '15 days program', link: 'https://bspso.crack-ed.com' },
...
const OPTION_TO_PROGRAMS = [
  {
    A: ['Banking Sales Program - Business Development Executive', 'Aviva Nirmaan Program - Direct Sales Executive', 'Mahindra Finance Prarambh Program - Business Executive'],
  ...
  {
    A: ['Banking Sales Program - Business Development Executive', 'Mahindra Finance Prarambh Program - Business Executive', 'Hero Housing Finance Pragati Program - Relationship Manager'],
  ...
  {
    A: ['Aviva Nirmaan Program - Direct Sales Executive', 'Banking Sales Program - Business Development Executive', 'Aviva Nirmaan Program - Agency Sales Executive'],
  ...
  {
    A: ['Aviva Nirmaan Program - Direct Sales Executive', 'Banking Sales Program - Business Development Executive', 'Mahindra Finance Prarambh Program - Business Executive'],
  ...
  {
    A: ['Aviva Nirmaan Program - Agency Sales Executive', 'Banking Sales Program - Business Development Executive', 'Mahindra Finance Prarambh Program - Business Executive'],
  ...
  {
    A: ['Banking Sales Program - Business Development Executive', 'Aviva Nirmaan Program - Agency Sales Executive', 'Mahindra Finance Prarambh Program - Business Executive'],
    B: ['Hero Housing Finance Pragati Program - Relationship Manager', 'Piramal ProEdge Program - Relationship Manager', 'Postgraduate Program Relationship Management - Relationship Manager'],
    C: ['Hero Housing Finance Pragati Program - Credit and Operations Manager', 'Bandhan Bank Aspiring Bank Champions Programme - Assistant Manager', 'Elevate Banking Program - Virtual Relationship Manager'],
    D: ['Hero Housing Finance Pragati Program - Collection Officer', 'Rupyy AutoEdge Program - Business Manager', 'Postgraduate Program Retail Banking - Relationship Officer'],
  },
