        ...
        <div className="footer-content">
          ...
          <div className="footer-column footer-quick-links">
            ...
            <ul className="footer-links">
              ...
              <li><a href="#podcast">BID Podcast</a></li>
            </ul>
          </div>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links footer-job-links">
              <li><a href="#aurum" className="footer-program-heading">AURUM Bankers Program</a></li>
              <li><a href="#rm">Relationship Manager</a></li>
              <li><a href="#gold-loan">Gold Loan</a></li>
              <li><a href="#casa">CASA</a></li>
              <li><a href="#mbl">Microbusiness Loan</a></li>
              <li><a href="#money-officer">Money Officer</a></li>
              <li><a href="#transaction-officer">Transaction Officer</a></li>
              <li><a href="#cso">Customer Service Officer</a></li>
              <li><a href="#valuation">Valuation</a></li>
              <li><a href="#dcm">Deputy Center Manager</a></li>
              <li><a href="#dlro">Deputy Late Recovery Officer</a></li>
              <li><a href="#lenskart" className="footer-program-heading">Lenskart Eyetech Program</a></li>
              <li><a href="#clinical">Clinical Technician</a></li>
              <li><a href="#retail">Retail Sales Associate</a></li>
            </ul>
          </div>
            ...
            <div className="footer-contact">
              ...
              <div className="contact-info">
                <div className="contact-item">
                  ...
                  <span>7th floor, Imperia Mindspace. Sector 62, Golf Course Road, Gurgaon</span>
                </div>
                <div className="contact-item">
                  <svg className="contact-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
